...
use sgoendoer\Sonic\Model\MigrationTransactionObjectBuilder;
use sgoendoer\Sonic\Model\RemoteObject;

/**
 * Represents a MIGRATION TRANSACTION object
 * version 20170224
 *
 * author: Sebastian Goendoer
 * copyright: Sebastian Goendoer <sebastian [dot] goendoer [at] gmail [dot] com>
 */
class MigrationTransactionObject extends RemoteObject
{
	const JSONLD_CONTEXT = 'http://sonic-project.net/';
	const JSONLD_TYPE = 'migration-transaction';
